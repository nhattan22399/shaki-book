            ...
            <form method="post" action="#">
                ...
                <div class="body-form">
                    ...
                    <div class="row-input">
                        ...
                        <input type="password" name="matkhau" value="'.$row["matkhau"].'"/></div>
...
if (isset($_POST['do-update']))
{
    ...
    $sql = "UPDATE khachhang set hoten = '".$name."', diachi = '".$add."', sodt = '".$phone."', email = '".$email."',  tendangnhap = '".$username."', matkhau = '".$matkhau."' WHERE makh=$id";
